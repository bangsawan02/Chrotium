                ...
                if (tab.url != "about:blank") {
                    ...
                    androidx.compose.runtime.key(tab.id) {
                        BrowserWebView(
                            ...
                            onNavigationStateChanged = { back, forward -> viewModel.onNavigationStateChanged(back, forward) },
                            onScriptsExecuted = { viewModel.onScriptsExecuted(it) },
        ...
        ActiveSheet.TRANSLATE -> {
            TranslateSheet(
                ...
                onTranslateUrl = { translateUrl ->
                    viewModel.openUrl(translateUrl)
                },
                onDismiss = { viewModel.hideSheet() }
            )
        }
