    ...
    val BACKGROUND_PLAY_SCRIPT = """
        (function() {
            ...
            try {
                ...
                document.addEventListener('visibilitychange', function(e) { if (e) e.stopImmediatePropagation(); }, true);
                document.addEventListener('webkitvisibilitychange', function(e) { if (e) e.stopImmediatePropagation(); }, true);
                window.addEventListener('pagehide', function(e) { if (e) e.stopImmediatePropagation(); }, true);
        ...
        (function() {
            ...
            try {
                ...
                function checkMediaStatus() {
                    try {
                        var isPlaying = !!(document.querySelector('video:not([paused])') || document.querySelector('audio:not([paused])'));
